...
describe("marketing media view models", () => {
  it("derives same-origin protected public media URLs from CMS media IDs", () => {
    ...
    const shell = createMarketingShellViewModel({ locale: "en", translationLocale: "en", usedFallback: false, summary: "", contact: { addressLines: [] }, navigation: [], logo: section.media }, { marketing: { navigation: { primary: "", language: "", footer: "" }, accessibility: { home: "", mobileNavigation: "", email: "", phone: "", socialLinks: "" }, public: { search: "" }, footer: { explore: "", contact: "", contactTeam: "", researchUseOnly: "" }, mobile: { menu: "", close: "" } }, actions: { requestQuote: "" }, consent: { manage: "" } } as never);
